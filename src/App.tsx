...
export default function App() {
  ...
  useEffect(() => {
    ...
    gsap.to('header', {
        backgroundColor: '#1E1E1E', // Solid black on scroll (was white)
        ...
        scrollTrigger: {
            ...
            onEnter: () => { 
                gsap.to('header nav a', { color: '#A7C840', duration: 0.3 }); // Change text color to lime green
                gsap.to('header .logo-text', { color: '#A7C840', duration: 0.3 }); // Change logo text to lime green
                gsap.to('header .mobile-menu-icon', { color: '#A7C840', duration: 0.3 }); // Change mobile menu icon to lime green
            },
            onLeaveBack: () => { 
                gsap.to('header nav a', { color: 'rgba(255, 255, 255, 0.8)', duration: 0.3 }); // Change text color back to white
                gsap.to('header .logo-text', { color: 'rgba(255, 255, 255, 0.8)', duration: 0.3 }); // Change logo text back to white
                gsap.to('header .mobile-menu-icon', { color: 'rgba(255, 255, 255, 0.8)', duration: 0.3 }); // Change mobile menu icon back to white
            }
        }
    });
    ...
    gsap.set('header .mobile-menu-icon', { color: 'rgba(255, 255, 255, 0.8)' }); // Initial mobile menu icon color white
    ...
    <div className="min-h-screen bg-[#2F2B2B] font-sans">
      ...
      <section id="home" className="relative h-screen min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl px-4 text-white" ref={mainRef}> {/* Added ref here */}
          ...
          <div>
            <a href="#about" className="inline-block bg-[#A7C840] text-black px-8 py-3 rounded-full font-bold hover:bg-opacity-90 transition-colors">
              Our Mission
            </a>
          </div>
        </div>
      ...
      <main>
        {/* About Section */}
        <section id="about" className="py-24 px-4 bg-[#2F2B2B] text-gray-200">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center space-y-6 text-lg">
              <p className="leading-relaxed">
                <span className="font-semibold text-[#A7C840]">QI SPORTS</span>
                <br/>
                EST: 2011<br/>
                REGISTERED: 2013<br/>
                UG. REG NO: 170893
              ...
              <h3 className="text-2xl font-bold mt-12 mb-6 text-[#A7C840]">What We Do</h3>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div
                  key={service.title}
                  className="bg-[#3A3A3A] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow"
                >
        ...
        {/* CSR Highlight */}
        <section className="py-24 px-4 bg-[#A7C840] text-black">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a href="#contact" className="inline-block bg-[#1E1E1E] text-white px-8 py-3 rounded-full font-bold hover:bg-opacity-90 transition-colors">
              Partner With Us
            </a>
          </div>
        </section>
        ...
        {/* Contact Section */}
        <section id="contact" className="py-24 px-4 bg-[#2F2B2B] text-gray-200">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12">
               {splitText("Get In Touch")}
            </h2>
            
            <div className="bg-[#3A3A3A] p-8 rounded-lg shadow-md">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-bold mb-4 text-[#A7C840]">Contact Information</h3>
                  ...
                  <div className="mt-8">
                    <h4 className="font-medium mb-2 text-[#A7C840]">Follow Us</h4>
                    <div className="flex space-x-4">
                      <a href="#" className="text-gray-300 hover:text-[#A7C840] transition-colors">
                        {/* Facebook icon */}
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 text-[#A7C840]">Send Us a Message</h3>
                  <form className="space-y-4">
                    <div>
                      <label htmlFor="name" className="block text-sm font-medium text-gray-300 mb-1">Your Name</label>
                      <input type="text" id="name" className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#A7C840] focus:border-[#A7C840]" />
                    </div>
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-1">Email</label>
                      <input type="email" id="email" className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#A7C840] focus:border-[#A7C840]" />
                    </div>
                    <div>
                      <label htmlFor="message" className="block text-sm font-medium text-gray-300 mb-1">Message</label>
                      <textarea id="message" rows={4} className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#A7C840] focus:border-[#A7C840]"></textarea>
                    </div>
                    <button type="submit" className="w-full bg-[#A7C840] text-black py-2 px-4 rounded-md hover:bg-opacity-90 transition-colors font-medium">
                      Send Message
                    </button>
                  </form>
                </div>
